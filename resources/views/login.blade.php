<x-layout>
    ...
    <form class="xl:max-w-4xl md:max-w-100 max-w-70 mx-auto mt-40 backdrop-blur bg-transparent " action="{{ route('login_submit') }}" method="post">
        @csrf
        ...
        <div class="flex items-start mb-5">
            <div class="flex items-center h-5">
                <label for="terms" class="text-sm font-medium ">Belum Punya akun? <a
                    href="{{ route('register') }}" class="text-blue-600 hover:underline text-sm dark:text-blue-500">Buat Akun</a></label>
                </div>
        </div>
