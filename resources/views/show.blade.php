    ...
    <div class="max-w-7xl mx-auto p-6 m-30 bg-white dark:bg-gray-900 rounded-lg shadow-md">
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="md:w-1/2">
                ...
                <p class="mb-2 text-gray-700 dark:text-gray-300">Harga: <strong>Rp
                        {{ number_format($hewan->harga_hewan, 2, ',', '.') }}</strong></p>
                ...
                <a href="https://wa.me/{{ $hewan->penjual->nomor_hp }}"
                    ...
                    <span class="relative text-base font-semibold">hubungi penjual via whatsapp</span>
                </a> <br>
                ...
                <a href="{{ route('beranda.produk') }}"
                    ...
                    <span
                        class="absolute w-0 h-0 transition-all duration-500 ease-out bg-blue-500 rounded-full group-hover:w-56 group-hover:h-56"></span>
                    <span class="absolute bottom-0 left-0 h-full -ml-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-auto h-full opacity-100 object-stretch"
                            viewBox="0 0 487 487">
                            <path fill-opacity=".1" fill-rule="nonzero" fill="#FFF"
