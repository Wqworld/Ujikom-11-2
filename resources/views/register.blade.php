<x-layout>
    ...
    <form class="xl:max-w-4xl md:max-w-100 max-w-70 mx-auto mt-40 backdrop-blur bg-transparent "
        ...
        <button type="submit"
            class="text-gray-500 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
