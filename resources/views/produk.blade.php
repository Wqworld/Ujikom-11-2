            ...
            <div
                ...
                <a href="#">
                    <div class="w-full aspect-[4/3] overflow-hidden rounded-t-lg">
                        <img class="w-full h-full object-cover" src="{{ asset('assets/logoDomba.png') }}"
                            alt="Gambar Hewan" />
                    </div>
                </a>
                <div class="p-5">
                    ...
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 max-w-100">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum, quas culpa quidem quaerat molestias eius nulla, nisi vitae ullam facilis sint necessitatibus, maiores itaque corporis autem et. Quo, deserunt delectus.
                    </p>
                    <a href="#"
